...
![Screenshot melihat list database](../Screenshoot/Modul2/7.PNG)
...
![Screenshot insert buku Overlord I](../Screenshoot/Modul2/8.PNG)
...
![Screenshot insert buku many](../Screenshoot/Modul2/9.PNG)

* ## Langkah 5
> Melakukan pencarian buku dengan menggunakan command db.books.find() untuk
melakukan pencarian semua buku.
![Screenshot pencarian buku](../Screenshoot/Modul2/10.PNG)
...
diisi>})
![Screenshot menampilkan seluruh buku](../Screenshoot/Modul2/11.PNG)
...
![Screenshot update buku](../Screenshoot/Modul2/13.PNG)
...
![Screenshot delete buku](../Screenshoot/Modul2/15.PNG)
